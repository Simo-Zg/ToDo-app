...
## 6. AWS Kubernetes deployment evidence

Show:

- AWS EKS cluster from `terraform/aws-staging`
- AWS ECR image pushed by `aws_ecr_package`
- `kubectl get pods -n todo-staging`
- exactly 1 `todo-app` pod and 1 `mongodb` pod
